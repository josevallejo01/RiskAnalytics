...
#' @param nNumPerTol numeric: Número de meses en los que se busca que se supere la tolerancia.
...
mxMoraCosechaHunter <- function(handle, dfBase, cFecIni, cFecFin,
                                ...
                                nOrder = 3, bCumDepth = FALSE, nTolerancia = 0.18,
                                nNumPerTol, batch = 1500,
